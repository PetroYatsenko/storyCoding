...
return a.drawImage(t,0,0),e.toDataURL("image/png")}var a=[],n=document.getElementById("story"),o=$("#pdf"),s=$("#edit"),i=$("#send"),r=$("#save"),d=$("#print"),l=$("#dload"),c=$("#story"),f=(function(){"undefined"!==sessionStorage.story&&sessionStorage?a=JSON.parse(sessionStorage.story):"undefined"!=typeof storyTxt&&storyTxt&&(a=JSON.parse(storyTxt))
