...
return a.drawImage(t,0,0),e.toDataURL("image/png")}var a=[],n=document.getElementById("story"),o=$("#pdf"),s=$("#edit"),i=$("#send"),r=$("#save"),d=$("#print"),l=$("#dload"),c=$("#story"),f=(function(){void 0!==sessionStorage.story?a=JSON.parse(sessionStorage.story):void 0!==typeof storyTxt&&(a=JSON.parse(storyTxt))
