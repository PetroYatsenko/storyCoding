...
// TODO refactor it in the more reasonable way?
 ...
 * @returns {undefined}
 */
exports.checkAccount = (req, res, next) => {
  req.sanitize('story');
  var strings = {
    uk: {
      hint: 'Акаунт "пісочниця" дозволяє пройти тільки першу історію курсу.' + 
        'В інших акаунтах доступні всі уроки, пояснення, практика, тести та інші чудові можливості.'
    }
  };
